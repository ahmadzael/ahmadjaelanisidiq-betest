...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            Optional<UserDetails> userDetails = accountRepository.findByUsername(userEmail);
            Optional<Account> account = accountRepository.findByToken(jwt);

            if (jwtService.isTokenValid(jwt, account.get())) {
